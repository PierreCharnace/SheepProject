<template>
  <div>
    ...
    >
      <form>
        <v-card-title class="d-flex justify-center"
          >Page de Profil</v-card-title
        >
        <div class="d-flex justify-center">
          <v-avatar color="teal" size="65">IP</v-avatar>
        </div>
        <v-list-item class=""
          ><!--Current infos-->
      ...
      <v-card-actions class="d-flex justify-center">
        <v-btn outlined rounded text @click="switchToModifyInformations()">
    ...
    >
      ...
      <v-card-actions class="d-flex justify-center">
        <v-btn outlined rounded text @click="switchToInformations()">
          Enregistrer mes informations
        </v-btn>
      </v-card-actions>
      <v-card-actions class="d-flex justify-center">
        <v-btn outlined rounded text> Effacer votre profil </v-btn>
      </v-card-actions>
    </v-card>
  </div>
</template>
